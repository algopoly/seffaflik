...
def ptf(baslangic_tarihi=__dt.datetime.today().strftime("%Y-%m-%d"),
        bitis_tarihi=__dt.datetime.today().strftime("%Y-%m-%d"), rename_tr=True):
    """
...
def hacim(baslangic_tarihi=__dt.datetime.today().strftime("%Y-%m-%d"),
          bitis_tarihi=__dt.datetime.today().strftime("%Y-%m-%d"), rename_tr=False, organizasyon_eic=""):
    """
...
def tum_organizasyonlar_hacim(baslangic_tarihi=__dt.datetime.today().strftime("%Y-%m-%d"),
                              bitis_tarihi=__dt.datetime.today().strftime("%Y-%m-%d"), rename_tr=False, hacim_tipi="NET"):
    """
...
def arz_talep_egrisi(tarih=__dt.datetime.today().strftime("%Y-%m-%d"), rename_tr=False):
    """
...
def kptf(tarih=(__dt.datetime.today() + __dt.timedelta(days=1)).strftime("%Y-%m-%d"), rename_tr=False):
    """
